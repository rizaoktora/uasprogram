...
<body class="background-color: #e6e6fa;">
  <div class="container">
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        <!-- Nested Row within Card Body -->
        <div class="row">
          <div class="col-lg-5 d-none d-lg-block bg-register-image" style="background-image: url('{{ asset('https://i.pinimg.com/564x/09/6f/5b/096f5bb3635d6d286e8ef411adeed5ff.jpg')}}');"></div>
          <div class="col-lg-7">
            <div class="p-5">
